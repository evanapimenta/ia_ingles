...
exports.MockProvider = exports.GeminiProvider = exports.OpenAIProvider = void 0;
    ...
    async generateJSON(prompt) {
        try {
            ...
            try {
                ...
                throw new Error(`Erro ao decodificar JSON do OpenAI: ${parseError.message}. Conteúdo: ${text}`);
            }
        }
        catch (error) {
    ...
    async generateJSON(prompt) {
        try {
            ...
            try {
                ...
                throw new Error(`Erro ao decodificar JSON do Gemini: ${parseError.message}. Conteúdo: ${text}`);
            }
        }
        catch (error) {
